            ...
            <button
              ...
              className={`
                ...
                ${activeCategory === cat.id
                  ...
                  : 'bg-white border-slate-200 text-slate-600 hover:border-slate-350 hover:bg-slate-50 dark:bg-[#0a0a0b] dark:border-white/10 dark:text-slate-350 dark:hover:border-indigo-500/50 dark:hover:text-white'
                }
              `}
            >
              {cat.label}
                ...
                >
                  <Card 
                    ...
                    className={`
                      ...
                      ${isExpanded ? 'ring-2 ring-indigo-600 dark:ring-indigo-505' : ''}
                    `}
                  >
                    <div>
                      {/* Top bar with tag */}
                      <div className="flex items-center justify-between">
                        <span className="text-[10px] font-extrabold uppercase tracking-widest text-slate-450 dark:text-slate-400">
                          {project.client}
                        </span>
                      ...
                      <div className="mt-5 flex flex-wrap gap-1.5" id={`project-stack-${project.id}`}>
                        {project.techStack.map((tech, i) => (
                          <span
                            key={i}
                            className="inline-flex items-center gap-1 rounded bg-slate-50/80 border border-slate-150/70 px-2.5 py-1 text-xs font-semibold text-slate-780 dark:bg-white/5 dark:border-white/5 dark:text-slate-300"
                          >
                      ...
                      <div className="mt-6 flex items-center gap-3.5 rounded-2xl bg-slate-50 border border-slate-200/80 p-4 dark:bg-white/5 dark:border-white/5">
                        ...
                        <div>
                          <p className="text-[10px] font-bold uppercase tracking-wider text-slate-450 dark:text-slate-400">
                            Measurable Outcome
                          </p>
